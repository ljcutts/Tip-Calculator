...
tipFive.addEventListener("click", () => {
  ...
  if (billValue > 0 && peopleNum > 0) {
    var BillTip = ((bill.value * (5 / 100)) / peopleNum).toFixed(2);
    var Total = (billValue + (bill.value * (5 / 100)) / peopleNum).toFixed(2);
...
tipTen.addEventListener("click", () => {
  ...
  var peopleNum = parseInt(numOfPeople.value);
  if (billValue > 0 && peopleNum > 0) {
    var BillTip = ((bill.value * (10 / 100)) / peopleNum).toFixed(2);
    var Total = (billValue + (bill.value * (10 / 100)) / peopleNum).toFixed(2);
    tipNum.innerHTML = `${BillTip}`;
    totalNum.innerHTML = `${Total}`;
    resetButton.style.opacity = "1";
  }
...
tipFifteen.addEventListener("click", () => {
  ...
  var peopleNum = parseInt(numOfPeople.value);
  if (billValue > 0 && peopleNum > 0) {
    var BillTip = ((bill.value * (15 / 100)) / peopleNum).toFixed(2);
    var Total = (billValue + (bill.value * (15 / 100)) / peopleNum).toFixed(2);
    tipNum.innerHTML = `${BillTip}`;
    totalNum.innerHTML = `${Total}`;
    resetButton.style.opacity = "1";
  }
...
tipTwentyFive.addEventListener("click", () => {
  ...
  var peopleNum = parseInt(numOfPeople.value);
  if (billValue > 0 && peopleNum > 0) {
    var BillTip = ((bill.value * (25 / 100)) / peopleNum).toFixed(2);
    var Total = (billValue + (bill.value * (25 / 100)) / peopleNum).toFixed(2);
    tipNum.innerHTML = `${BillTip}`;
    totalNum.innerHTML = `${Total}`;
    resetButton.style.opacity = "1";
  }
...
tipFifty.addEventListener("click", () => {
  ...
  var peopleNum = parseInt(numOfPeople.value);
  if (billValue > 0 && peopleNum > 0) {
    var BillTip = ((bill.value * (50 / 100)) / peopleNum).toFixed(2);
   var Total = (billValue + (bill.value * (50 / 100)) / peopleNum).toFixed(2);
    tipNum.innerHTML = `${BillTip}`;
    totalNum.innerHTML = `${Total}`;
    resetButton.style.opacity = "1";
  }
...
leftSide.addEventListener("input", () => {
  ...
  var peopleNum = parseInt(numOfPeople.value);
  var billTip = ((bill.value * (customTipper / 100)) / peopleNum).toFixed(2);
  var totalAmount = (billValue + (bill.value * (customTipper / 100)) / peopleNum).toFixed(
    2
  );
  if (billValue < 0) {
